var G=Object.defineProperty;var V=(i,e,t)=>e in i?G(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var l=(i,e,t)=>V(i,typeof e!="symbol"?e+"":e,t);import{M as H,U as W,S as j,O as Y}from"./orbit_panel-ByLhCXyj.js";const Z=`/**
...
`}vec4(${_}, ${f}, ${p}, ${T})`,n+=1}return`
      ...
      const vec4 DISC_PARTICLE_PARAMS[${n}] = vec4[${n}] (
        ${r}
      );`},z=function(i,e,t){const r=i.createShader(e);if(!r)throw new Error("Could not create WebGL shader");if(i.shaderSource(r,t),i.compileShader(r),!i.getShaderParameter(r,i.COMPILE_STATUS)){const o=i.getShaderInfoLog(r);console.error("Shader compilation error:",o)}return r};class me{constructor(e,t,r){l(this,"model");l(this,"textureManager");l(this,"gl");l(this,"programs",{});l(this,"program",null);this.model=e,this.textureManager=t,this.gl=r,this.programs={},this.program=null}getProgram(){const e=`#define LENSING ${this.model.lensing.getValue()?1:0}
        ...
        const float MAX_FOOTPRINT_LOD =
            float(${this.model.grid.getValue()?0:de});
